...
public class PlayerLivesManager : MonoBehaviour
{
    ...
    public GameObject playerUI; // Drag your HUD Canvas (playerUI) here in Inspector
    public CinemachineCamera virtualCamera;

    private int deathCount = 0;
    private Vector3 respawnPoint;
    private float deathUIDelay = 3f; // Delay in seconds before showing death UI
    ...
    public void PlayerDied()
    {
        ...
        else
        {
            ...
            {
                Debug.LogWarning("Player UI not assigned in PlayerLivesManager!");
            }
